...
public class ACCTitleProcessMR {
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 3) {
			System.err.println("Usage: ACCTitleProcessMR <day> <input> <output>");
			System.exit(2);
		}
		String day = otherArgs[0];
		Job job = new Job(conf, "ACCTitleProcessMR_" + day);
		job.setJarByClass(ACCTitleProcessMR.class);
