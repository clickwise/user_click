...
public class EWATagNounUnCate {
			...
			if ((seg_title != null) && (!(seg_title.equals(""))) && (seg_title.length() > 5)) {
				try {
					...
					key_s=keyword_extract(tag_s);
					  ...
					  {
					    new_line=url+"\001"+cate+"\001"+key_s;
					  }
					}
	...
	public static void main(String[] args) throws Exception {
		...
		EWATagNounUnCate ewauc = new EWATagNounUnCate();
		ewauc.load_local_config();
		...
		while ((line = br.readLine()) != null) {
			...
			new_line = ewauc.line_process(line);
