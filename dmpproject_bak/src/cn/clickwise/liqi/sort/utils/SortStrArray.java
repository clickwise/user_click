package cn.clickwise.liqi.sort.utils;

import java.util.ArrayList;
import java.util.Collections;

import cn.clickwise.liqi.mapreduce.app.swa_analysis.SWAWCPP.SortElement;
import cn.clickwise.liqi.str.basic.SSO;

/**
 * 输入一个字符串数组,各个字段用"\001"分开，指定排序依据的字段编号，返回排序后的数组
 * @author zkyz
 *
 */
public class SortStrArray {
	 ...
	 * arr:待排序的数组
	 * key_index:排序key的索引
	 * key_type:排序key的类型，例如str,int,dou
	 * @param arr
	 * @param key_index
	 * @param key_type
	 * @return
