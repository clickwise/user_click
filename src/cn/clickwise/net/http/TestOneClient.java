...
public class TestOneClient {
	...
	public static void main(String[] args)
	{
	   ...
	   // String prefix="http://42.62.29.24:8900/cate_tb/do?t=";
	    ...
	    //String prefix="http://42.62.29.25:8000/matchad.json?uid=c0b8023c87b2fc259e7e456a80f6285e&datatype=BAIDU,TBSEARCH&infotype=cates,attrs,items,bdcates,bdkeys&adinfotype=keywords&platform=adshow";
	    ...
	    String prefix="http://42.62.29.25:8000/matchuseradsimilarity.json?uid=c0b8023c87b2fc259e7e456a80f6285e&adids=test_1,test_2,3,4,5,6&datatype=BAIDU,TBSEARCH&infotype=cates,attrs,items,bdcates,bdkeys&adinfotype=keywords&platform=adshow";
			...
			if (statusCode == HttpStatus.SC_OK) {
				...
				if (entity != null) {
					...
					while(it.hasNext())
					{
						...
						{
							System.out.println(Base64Code.getDecodeStr(jsonArray.get(i)+""));
						}
