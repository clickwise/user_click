...
public class CLKSelProcessMR {
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 3) {
			System.err.println("Usage: CLKSelProcess <day> <input> <output>");
			System.exit(2);
		}
		String day = otherArgs[0];
		Job job = new Job(conf, "CLKSelProcess_" + day);
		job.setJarByClass(CLKSelProcessMR.class);
